...
<style>
      ...
      #submenu{
        ...
        thead tr th:nth-child(2){width: 200px;}
        thead tr th:nth-child(3){width: 20px; text-align: left;}
                ...
                <div id="content">
                    ...
                    <table class="tbl">
                        ...
                        <c:if test="${dto.size()==0}">
                        	<tr>
                        	<td colspan="5">완료된 계약이 없습니다.</td>
                        	</tr>
                        </c:if>
                        <c:forEach items="${dto}" var="dto">
                            <tr>
                                <td>${dto.rownum}</td>
                                <td><a href="../member/complete.do?postseq=${dto.postseq}">${dto.subject}</a></td>
                                <td>${dto.id}</td>
                                <td>${dto.regdate}</td>
                                <td><input type="text" value="${dto.filename=='null'?'미등록':'등록' }" disabled></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
