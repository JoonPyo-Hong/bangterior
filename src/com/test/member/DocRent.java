...
@WebServlet("/member/docrent.do")
public class DocRent extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String hconseq = req.getParameter("hconseq"); //상담 번호 받기
		...
		req.setAttribute("seq", seq);
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/member/docrent.jsp");
